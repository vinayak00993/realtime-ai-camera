...
export function ControlBar({
  ...
  return (
    <div
      className="absolute bottom-0 left-0 right-0 px-2 pt-2 pb-2 pointer-events-auto"
      style={{
    ...
    >
      ...
      {/* Top row: camera toggle + voice toggle */}
      <div className="flex justify-between mb-2 px-1">
        <button
          onClick={onToggleCamera}
          className="h-8 px-3 rounded-full bg-white/10 backdrop-blur-sm flex items-center gap-1.5 active:bg-white/20 transition-colors"
        >
          <svg
      ...
      {/* Bottom row: input + mic + send */}
      <div className="flex items-center gap-2">
        {/* Text input */}
        <div className="flex-1 flex items-center bg-white/15 backdrop-blur-sm rounded-full px-4 min-w-0">
          <input
            type="text"
            value={input}
            ...
            className="flex-1 h-11 bg-transparent text-white placeholder-white/40 text-sm outline-none min-w-0"
